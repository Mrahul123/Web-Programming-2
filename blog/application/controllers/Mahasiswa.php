...
class Mahasiswa extends CI_Controller{
    ...
    public function save(){
        //akses model mahassiwa
        $this->load->model('mahasiswa_model','mahasiswa');//1 bkin variable
